	...
	<div class="flex-column-row-gap">
		...
		<div class="cardMosaic">
			...
			<div class="cardTwo mosaicCard">
				<h2>Housing Should Be Free!</h2>
				<p>
					Housing should be as free today as inhabiting a cave would have been ten thousand years
					ago. Whatever buildings have been built, should be considered as common inheritance of
					humanity, to be used for the greatest good. If you're paying rent to inhabit your home,
					you're not free as the caveman was - you're in fact in a relationship similar to slavery
					with your landlord.
				</p>
			</div>
